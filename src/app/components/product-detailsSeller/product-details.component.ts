import { Data } from 'memfs/lib/fsa/types';
...
import { ReviewsSellerComponent } from "../reviewsSeller/reviews.component";

@Component({
  selector: 'app-product-details-seller',
  imports: [CommonModule, ReviewsComponent, ReviewsSellerComponent],
  standalone: true,
  templateUrl: './product-details.component.html',
  styleUrls: ['./product-details.component.css']
})
export class ProductDetailsSellerComponent implements  OnInit{
